...
public class AnimatedModel {
	...
	/**
	 * @return The root joint of the joint hierarchy. This joint has no parent, and
	 *         every other joint in the skeleton is a descendant of this joint.
	 */
	...
	/**
	 * Instructs this entity to carry out a given animation. To do this it basically
	 * sets the chosen animation as the current animation in the {@link Animator}
	 * object.
	 * 
	...
	/**
	 * Updates the animator for this entity, basically updating the animated pose of
	 * the entity. Must be called every frame.
	 */
	public void update() {
		animator.update();
	}
	...
	public void moveMe(Vector3f moveTo) {
		float x = this.position.getX() + moveTo.getX();
		float y = this.position.getY() + moveTo.getY();
		float z = this.position.getZ() + moveTo.getZ();
	...
	public void setLookingAt(Quaternion lookingAt) {
		this.lookingAt = lookingAt;
	}

	public Quaternion getLookingAt() {
		return lookingAt;
	}
