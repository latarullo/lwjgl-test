...
public class Animator {
	...
	private Map<String, Matrix4f> lastPose = null;
	...
	public void update() {
		...
		if (entity.isMoving()) {
			...
			applyPoseToJoints(currentPose, entity.getRootJoint(), new Matrix4f().translate(entity.getPosition()).rotate(entity.getRotation(), new Vector3f(0, 1, 0)));
			lastPose = currentPose;
		}else {
			increaseAnimationTime();
			applyPoseToJoints(lastPose, entity.getRootJoint(), new Matrix4f().translate(entity.getPosition()).rotate(entity.getRotation(), new Vector3f(0, 1, 0)));
		}
	}
